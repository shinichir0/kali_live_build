...
cp /root/dotfiles-kali/wl/broadcom-wl-dkms.tar.gz /tmp/broadcom/
cp /root/dotfiles-kali/wl/hybrid-v35_64-nodebug-pcoem-6_30_223_271.tar.gz /tmp/broadcom/broadcom.tar.gz
